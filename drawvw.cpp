...
//void CDrawView::OnDrawTest()
//{
//	CMainFrame* myFrame = (CMainFrame*)GetParentFrame();
//	myFrame->SwitchView(VIEWID_SEARCH);
//}
...
{
	if (GetDocument()->IsSearchAndOrganizeHandler())
	{
		return;
	}
